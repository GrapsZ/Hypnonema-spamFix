namespace Hypnonema.Server
{
    ...
    public class Server : BaseScript
    {
        ...
        private void OnResourceStart(string resourceName)
        {
            ...
            IsDebugMode = ConfigReader.GetConfigKeyValue(resourceName, "hypnonema_debugmode", 0, IsDebugMode);
        ...
        private void OnOpen([FromSource] Player p, string key)
        {
            ...
            p.TriggerEvent(ClientEvents.ShowNUI, this.IsPlayerAllowed(p), JsonConvert.SerializeObject(screens));
        }
